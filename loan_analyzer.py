...
print(f"the total loan amount is $ {sum_loans}.")
...
print("Remaining Months: ", loan["remaining_months"])
...
print(f"Fair Value of the loan is ${present_value}")
...
if present_value > loan_price:
    print("Take the plunge! It's worth more than the cost!")
elif present_value == loan_price:
    print("Take the plunge! It's worth what it is selling for.")   
else: 
